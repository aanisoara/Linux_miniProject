...
# installed.
TCL_PREFIX='/root/projet_linux/anacondaa'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/root/projet_linux/anacondaa'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /root/projet_linux/anacondaa/include -fdebug-prefix-map=/tmp/build/80754af9/tk_1632504419923/work=/usr/local/src/conda/tk-8.6.11 -fdebug-prefix-map=/root/projet_linux/anacondaa=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /root/projet_linux/anacondaa/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/root/projet_linux/anacondaa/lib -Wl,-rpath-link,/root/projet_linux/anacondaa/lib -L/root/projet_linux/anacondaa/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/root/projet_linux/anacondaa/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/root/projet_linux/anacondaa/include'
...
TCL_PACKAGE_PATH='{/root/projet_linux/anacondaa/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/root/projet_linux/anacondaa/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1632504419923/work/tcl8.6.11/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/root/projet_linux/anacondaa/lib/libtclstub8.6.a'
